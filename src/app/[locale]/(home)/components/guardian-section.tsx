          ...
          >
            ...
            <div className={"flex flex-col w-full"}>
              ...
              >
                ...
                >
                  {t("home.g2e.connect.description")}
                </p>
              </div>
            </div>
          </div>
