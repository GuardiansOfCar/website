...
export default function PushAlertCreatePage() {
  ...
  const handleSubmit = async () => {
    ...
    const parsedTargetIds = targetIds
      .split(",")
    ...
    try {
      await fetch("/admin-notification/create", {
        method: "POST",
        data: payload,
      });
        ...
        <div key={lang.id} className="space-y-4 rounded-md border p-4">
          <div className="flex items-center space-x-4">
            ...
            <Select
              value={lang.language}
              onValueChange={(value) =>
                updateLanguageField(lang.id, "language", value)
              }
            >
              <SelectTrigger className="w-[180px]">
                <SelectValue />
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="w-full">
              <Input
                value={lang.title}
                onChange={(e) =>
                  updateLanguageField(lang.id, "title", e.target.value)
                }
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="w-full">
              <Textarea
                value={lang.content}
                onChange={(e) =>
                  updateLanguageField(lang.id, "content", e.target.value)
                }
