...
import { HomeContainer } from "@/app/v2/[locale]/(home)/components/home-container";
...
const structuredData = {
  ...
  description: "GOTCAR transforms real-time driving data into secure, private, and valuable digital assets. Powered by AI Mobility Agent, building a safer, smarter, and decentralized mobility ecosystem.",
  foundingDate: "2024",
  sameAs: [
    "https://x.com/gotcar_official",
...
const productStructuredData = {
  ...
  "@type": "Product",
  name: "GOTCAR Token",
  description: "The utility token of Guardians of the Car, the first-ever car meme project with a mission to revolutionize the global mobility ecosystem. Used for mobility-related payments, G2E rewards, staking, and community incentives.",
  brand: {
    "@type": "Brand",
    name: "GOTCAR",
  },
...
const softwareApplicationStructuredData = {
  ...
  description: "AI-powered mobility app that transforms driving data into valuable digital assets. Features include precision positioning, AI risk alerts, smart payments, and Guardians-to-Earn rewards.",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "USD",
