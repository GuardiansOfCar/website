...
import { API_BASE_URL, WALLET_CONNECT_PROJECT_ID } from "@/app/v2/lib/constants";
...
import { useOtpStore } from "@/app/v2/lib/use-otp-store";
import { solana, mainnet, AppKitNetwork, bsc } from "@reown/appkit/networks";
import { SolanaAdapter } from "@reown/appkit-adapter-solana/react";
import { createAppKit } from "@reown/appkit/react";
import { useWalletStore } from "@/app/v2/lib/use-wallet-store";
import useSWR from "swr";
import { useTranslations } from "next-intl";
import { WalletManagePopup } from "@/app/v2/components/wallet-manage-popup";
