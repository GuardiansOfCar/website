...
import {
  ...
  SidebarProvider,
  SidebarTrigger,
} from "@/app/v2/components/ui/sidebar";
  ...
  return (
    <ThemeProvider>
      <SidebarProvider>
        <AdminSidebar />
        <SidebarInset>
          <header className="flex h-16 shrink-0 items-center gap-2 border-b border-sidebar-border px-4 bg-white dark:bg-black">
          ...
          <div className="flex flex-1 flex-col gap-4 p-4 bg-white dark:bg-black">
