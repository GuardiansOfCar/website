...
import {Checkbox} from "@/app/v2/components/checkbox";
import {Button} from "@/app/v2/components/button";
import {useWallet} from "@/app/v2/lib/use-wallet";
import {useReferralStore} from "@/app/v2/lib/use-referral-store";
import {useForm} from "react-hook-form";
import {API_BASE_URL} from "@/app/v2/lib/constants";
import dayjs from "dayjs";
import duration from "dayjs/plugin/duration";
import {useParams, useSearchParams} from "next/navigation";
import {cn, getCoinLabel, getReferral} from "@/app/v2/lib/utils";
import {Coin, Network} from "@/app/v2/lib/use-wallet-store";
import {useMetaMask} from "@/app/v2/lib/use-metamask";
import {usePhantom} from "@/app/v2/lib/use-phantom";
